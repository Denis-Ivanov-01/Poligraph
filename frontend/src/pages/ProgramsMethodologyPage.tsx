...
export function ProgramsMethodologyPage() {
  const { data: methodologyContent, loading, error } = useAsync(() => getMethodology("programs"), []);
  ...
  return (
    <article className="methodology-page">
      <div className="detail-hero methodology-hero">
        ...
        <h1>{text.methodology.programsTitle}</h1>
